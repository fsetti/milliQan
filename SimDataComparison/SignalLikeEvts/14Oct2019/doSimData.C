{
  ...
  std::ifstream file("/home/users/fsetti/milliQan/SimDataComparison/SignalLikeEvts/14Oct2019/MCfiles.txt");
//  std::ifstream file("/home/users/fsetti/milliQan/SimDataComparison/SignalLikeEvts/14Oct2019/MCfiles_m0p5.txt");
//  std::ifstream file("/home/users/fsetti/milliQan/SimDataComparison/SignalLikeEvts/14Oct2019/MCfilesProb.txt");
  std::string line;
  ...
  while (std::getline(file, line) ){
	...
	plotHist( plotInfo.at(0), "nPEdT_slab18", "_0p01", true );
	plotHist( plotInfo.at(1), "nPEdT_slab18", "_0p03", true );
	plotHist( plotInfo.at(2), "nPEdT_slab18", "_0p05", true );
	plotHist( plotInfo.at(3), "nPEdT_slab18", "_0p07", true );
	plotHist( plotInfo.at(4), "nPEdT_slab18", "_0p1", true );
//   compareHists( plotInfo.at(0),   plotInfo.at(1),  plotInfo.at(2),  plotInfo.at(3),  plotInfo.at(4), "MC_nPE_slabs" );
//   compareHists( plotInfo.at(0),   plotInfo.at(1),  plotInfo.at(2),  plotInfo.at(3),  plotInfo.at(4), "trueMC_nPE_slabs" );
//   compareHists_v2( plotInfo.at(0),   plotInfo.at(1),  plotInfo.at(2),  plotInfo.at(3),  plotInfo.at(4), "MC_nPE_bars" );
