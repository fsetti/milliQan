...
/////////////////////////////////////////////////////////////////////////////
//	Muon Selection - hits in vertical line 
    vector<vector<vector<float>>> muonPulses;
    muonPulses = CosmicSelection ( chan,height,ptime,nPE,time_module_calibrated, {trig100248,trig101259,trig1161612,trig1171713,trig142224,trig143235} );
    if ( muonPulses.size() == 0 ) continue;

    vector<vector<float>> neighPulsesL1, neighPulsesL2, neighPulsesL3;
    neighPulsesL1 = CosmicsNeighBarSelection_diag ( chan,height,ptime,nPE,time_module_calibrated, trigL1 );
    neighPulsesL2 = CosmicsNeighBarSelection_diag ( chan,height,ptime,nPE,time_module_calibrated, trigL2 );
    neighPulsesL3 = CosmicsNeighBarSelection_diag ( chan,height,ptime,nPE,time_module_calibrated, trigL3 );
