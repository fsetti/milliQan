...
// second layer
const vector<int> trig67 = {6,7};
const vector<int> trig1617 = {16,17};
const vector<int> trig1213 = {12,13};
...
// third layer
const vector<int> trig23 = {2,3};
const vector<int> trig2223 = {22,23};
const vector<int> trig45 = {4,5};
...
// trig for neighbouring bars
const vector<int> trigN062 = {1,24,7,16,3,22};
const vector<int> trigN173 = {0,25,6,17,2,23};
const vector<int> trigN241622 = {0,8,25,6,12,17,2,4,23};
const vector<int> trigN251723 = {1,9,24,7,13,16,3,5,22};
const vector<int> trigN8124 = {24,9,16,13,22,5};
const vector<int> trigN9135 = {25,8,17,12,23,4};
// trig for non-neighbouring bars
const vector<int> trignonNtop = {8,9,12,13,4,5};
const vector<int> trignonNbot = {0,1,6,7,2,3};
const vector<int> trigPanels = {10,11,14,27,29,30,19,31,26};
