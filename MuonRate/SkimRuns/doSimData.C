{
  gROOT->ProcessLine(".L /home/users/fsetti/milliQan/MuonRate/SkimRuns/selection.C+");
  ...
  output_file_name = "/home/users/fsetti/milliQan/MuonRate/MuonFiles/Skim_muonStudy.root";
